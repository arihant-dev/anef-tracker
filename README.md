...
[![Build Status](https://github.com/anef-tracker/anef-tracker/actions/workflows/test.yml/badge.svg)](https://github.com/anef-tracker/anef-tracker/actions/workflows/test.yml)
[![Security Analysis](https://github.com/anef-tracker/anef-tracker/actions/workflows/security.yml/badge.svg)](https://github.com/anef-tracker/anef-tracker/actions/workflows/security.yml)
[![Go Version](https://img.shields.io/github/go-mod/go-version/anef-tracker/anef-tracker)](https://golang.org)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Release](https://img.shields.io/github/v/release/anef-tracker/anef-tracker?include_prereleases)](https://github.com/anef-tracker/anef-tracker/releases)
[![Go Report Card](https://goreportcard.com/badge/github.com/anef-tracker/anef-tracker)](https://goreportcard.com/report/github.com/anef-tracker/anef-tracker)
...
Download standalone cross-platform archives for macOS (`arm64`/`amd64`), Linux, or Windows directly from [GitHub Releases](https://github.com/anef-tracker/anef-tracker/releases).
