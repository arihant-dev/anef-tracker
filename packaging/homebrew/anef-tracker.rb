class AnefTracker < Formula
  ...
  homepage "https://github.com/arihant-dev/anef-tracker"
  url "https://github.com/arihant-dev/anef-tracker/releases/download/v0.9.0/anef-tracker_0.9.0_darwin_arm64.tar.gz"
